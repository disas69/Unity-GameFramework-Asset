                ...
                if (property.isExpanded)
                {
                    using (new GUIIndent())
                    {
                        ...
                        if (count > 0)
                        {
                            ...
                            if (indexToRemove >= 0)
                            {
                                var elementAtIndex = property.GetArrayElementAtIndex(indexToRemove);
                                if (elementAtIndex.propertyType == SerializedPropertyType.ObjectReference)
                                {
                                    elementAtIndex.objectReferenceValue = null;
                                }
